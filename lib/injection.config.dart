...
import 'infrastructure/datasources/local_preferences_datasource.dart' as _i13;
...
import 'infrastructure/repositories/planeacion_repository.dart' as _i11;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.PlaneacionRepository>(() => _i11.PlaneacionRepository(
      get<_i6.InspeccionesRemoteDataSource>(), get<_i4.Database>()));
  await gh.factoryAsync<_i12.SharedPreferences>(
      () => sharedPreferencesInjectableModule.prefs,
      preResolve: true);
  gh.lazySingleton<_i13.LocalPreferencesDataSource>(() =>
      _i13.SharedPreferencesDataSourceImpl(get<_i12.SharedPreferences>()));
  gh.factory<_i14.UserRepository>(() => _i14.UserRepository(
      get<_i6.InspeccionesRemoteDataSource>(),
      get<_i13.LocalPreferencesDataSource>()));
  gh.factory<_i15.AuthBloc>(
      () => _i15.AuthBloc(userRepository: get<_i14.UserRepository>()));
  gh.factory<_i16.LoginControl>(
      () => _i16.LoginControl(get<_i14.UserRepository>()));
  gh.factory<_i17.SincronizacionCubit>(
      () => _i17.SincronizacionCubit(get<_i14.UserRepository>()));
  return get;
}
